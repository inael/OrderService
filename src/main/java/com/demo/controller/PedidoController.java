...
public class PedidoController {
    ...
    public PedidoController() {
        ...
        // Podemos configurar outros validadores
    }
    ...
    @GetMapping(value = "/controle/{numeroControle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/por-data", produces = MediaType.APPLICATION_JSON_VALUE)
